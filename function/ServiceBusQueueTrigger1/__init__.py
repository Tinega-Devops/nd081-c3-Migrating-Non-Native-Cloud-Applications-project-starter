...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="azureuser@migration-db-server", password="betaa123#", host="migration-db-server.postgres.database.azure.com")
